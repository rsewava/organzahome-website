...
<html	lang		="en-GB">
	<head>
		...
		<meta	content		="A Curated digital storefront curated to bring inspired living into every room through gifts, intentional home decor, and household essentials."
				name		="Description"/>
		<meta	content		="Rodney Sewava Isaac Tajir Mattar"
				name		="Author"/>
			...
			<nav	aria-label	="Main Navigation"
				...
				<div	class		="o_main_nav container"
                    ...
                    <ul role="menu" id="top_menu" class="nav navbar-nav top_menu o_menu_loading mx-auto">
                        ...
                        <li role="presentation" class="nav-item">
                            <a role="menuitem" href="/shop/category/jewelry-21" class="nav-link ">
                                <span>Jewelry</span>
                            </a>
                        </li>
                        <li role="presentation" class="nav-item">
                            <a role="menuitem" href="/shop/category/accessories-22" class="nav-link ">
                                <span>Accessories</span>
                            </a>
                        </li>
                        <li role="presentation" class="nav-item">
                            <a role="menuitem" href="/shop/category/sale-26" class="nav-link ">
                                <span>SALE</span>
                            </a>
                        </li>
                    </ul>
